                                    ...
                                    <div class="row ">
                                      <div class="col-sm-6 ">
                                        <div class="form-group">                
                                          <b><label for="f2" class="text-white">CLASE</label></b></br>
                                          <label for="f1"> </label><span class="badge rounded-pill badge-light text-primary ml-2"  id="id_clase"> - </span>
                                        </div>
                                      </div>	
                                      <div class="col-sm-6 border-left">
                                        <div class="form-group">                
                                          <b><label for="f2" class="text-white">LEADTIME</label></b></br>
                                          <label for="f1" > </label><span class="badge rounded-pill badge-light text-primary ml-2"  id="id_leadtime" > - </span>
                                        </div>
                                      </div>	    
                                    </div>
                                  </div>
                                ...
                                <div class="card-body">
                                    <div class="row mb-3">
                                      ...
                                      <div class="col-sm-2 text-center" >
                                        <img src="{{ asset('img/placeholder.jpg') }}" alt="Imagen" class="img-fluid img-thumbnail" style="height: 100%; width: 150px" id="id_product_img">
                                      </div>

                                      <div class="col-sm-3">
                                          <div class="card card-social" style="height: 100px">
                                              <div class="card-header text-center bg-blue">
                                                  <h6 class="text-white m-0">M.O.Q</h6>
                                              </div>
                                              <div class="card-body ">
                                                <h6 class="text-center  font-weight-bold" style="font-size: 1.3rem!important"  id="id_moq"> 0.00</h6>
                                      ...
                                      <div class="col-sm-3">
                                          <div class="card card-social" style="height: 100px">
                                              <div class="card-header text-center bg-blue">
                                                  <h6 class="text-white m-0">PEDIDO</h6>
                                              </div>
                                              <div class="card-body ">
                                                <h6 class="text-center  font-weight-bold" style="font-size: 1.3rem!important"  id="id_pedido"> 0.00</h6>
                                      ...
                                      <div class="col-sm-4">
                                          <div class="card card-social" style="height: 100px">
                                              <div class="card-header text-center bg-blue">
                                                  <h6 class="text-white m-0">TRANSITO ( <span id="id_via_transito_lbl"></span> )</h6>
                                              </div>
                                              <div class="card-body ">
                                                <h6 class="text-center  font-weight-bold" style="font-size: 1.3rem!important"  id="id_transito"> 0.00</h6>
