                                    ...
                                    <tr>
                                        <td style="width: 550px;">
                                            <div class="d-flex align-items-center position-relative mt-2">                                
                                                ...
                                                <a href="#!" id="exp_more" class="exp_more text-dark" idArt="{{ $p['Articulo'] }}" ini="{{$p['fechaIni']}}" ends="{{$p['fechaFin']}}"><h6 class="mb-0 fw-semi-bold"><div class="stretched-link text-900">{{ $p['Descripcion'] }}</div></h6></a>
