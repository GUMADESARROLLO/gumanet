...
<link rel="stylesheet" type="text/css" href="{{ url('css/dataTables.dataTables.css') }}">

<link rel="stylesheet" href="{{ url('css/responsive.bootstrap4.min.css') }}">

<link rel="stylesheet" type="text/css" href="{{ url('css/fixedColumns.dataTables.css')}}">
...
<script src="{{ url('js/dataTables.fixedColumns.js') }}"></script>
<script src="{{ url('js/fixedColumns.dataTables.js') }}"></script>
