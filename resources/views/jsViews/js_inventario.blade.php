...
$(document).ready(function() {
    ...
    switch(emp) {
        ...
        columns = [
            ...
            { title: "PROM UNITS/ MES 2023",    data: "PROM_VST_ANUAL" },
            { title: "TOTAL UNITS 2023",        data: "VST_ANNO_ACTUAL" },
            { title: "PROM. UNITS/ MES 2022",   data: "PROMEDIO_VENTA" },
            { title: "TOTAL UNITS 2022",        data: "CANT_ANIO_PAS" },
...
function liquidacionPorMeses(valor) {
    $('#tblArticulosVencimiento').DataTable({
        ...
        'columns': [
            ...
            { "title": "TOTAL UNITS 2023",      "data": "VTS_ANIO_ANT" },
            { "title": "PROM. UNITS/MES 2024",  "data":  "PROMEDIO_VENTA" },
