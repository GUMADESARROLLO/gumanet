        ...
        $.each(json, function (i, item) {
            ...
            switch (item['tipo']) {
                ...
                case 'dtaVentasDiarias':
                    ...
                    chart.yAxis[0].options.plotLines[0].label.text = "Valor Prom. Diario C$ " + numeral(goal).format('0,0.00');

                    chart.yAxis[0].options.plotLines[1].value = var_Day_Max
                    chart.yAxis[0].options.plotLines[1].label.text = "Valor Prom. Tendencia C$ " + numeral(Tendencia ).format('0,0.00');
