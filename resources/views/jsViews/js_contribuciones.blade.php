...
$(document).ready(function () {
    ...
    let Table = new DataTable('#table_contribucion',{ 
        ...
        "columnDefs": [        
            ...
            { "width": "70px", "targets": [ 4, 5, 6, 7, 9, 10, 11, 12, 13, 16, 18, 19, 22, 24, 25, 28, 30, 31, 36, 37, 40, 41, 42, 43 ] },
            { "width": "90px", "targets": [ 8, 14, 20, 26, 32, 38, 44 ] },
            { "width": "90px", "targets": [ 35 ] },
            { "width": "80px", "targets": [ 17, 23, 29, 34 ] },
            { "width": "40px", "targets": [ 9, 15, 21, 27, 33, 45 ] },
