...
Route::get('/detallesTodosItems/{mes}/{anio}/{segmento}','dashboard_controller@get_Vta_all_items');
...
Route::get('/detailsAllCls','dashboard_controller@getAllClientsByCategory');
